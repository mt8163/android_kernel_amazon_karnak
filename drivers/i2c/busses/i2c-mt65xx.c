...
struct mtk_i2c {
	...
	bool pm_init_status;		/* i2c pm status */
			    ...
			    struct i2c_msg msgs[], int num)
{
	...
	if(i2c->pm_init_status == false){
		dev_err(i2c->dev, "mtk_i2c_transfer status is not ready!\n");
		dump_stack();
	}

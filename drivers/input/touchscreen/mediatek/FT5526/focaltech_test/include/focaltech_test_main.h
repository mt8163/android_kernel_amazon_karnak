...
#elif ((FT3C47_TEST) || (FT5822_TEST) || (FT5X46_TEST))
#define IC_Capacitance_Type	 1
#elif ((FT8606_TEST) || (FT8607_TEST) || (FT8716_TEST) || (FT8736_TEST) || (FTE716_TEST) || (FTE736_TEST))
...
#define FTS_TEST_PRINT(fmt, args...) printk(KERN_ERR "" fmt, ## args)

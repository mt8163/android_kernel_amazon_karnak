...
/*Starting from this is the Self Capacitance test item, the Mutual Capacitance of each test item must be put on the top.*/
...
/*Starting from this is the force touch test item the Self Capacitance of each test item must be put on the top.*/

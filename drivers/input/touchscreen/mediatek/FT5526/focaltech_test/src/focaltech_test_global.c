...
#define IC_TEST_VERSION "Test version: V1.0.0--2016-08-01, (sync version of FT_MultipleTest: V2.9.0.1--2015-12-22)"
...
void *fts_malloc(size_t size)
{
	...
	if (FTS_MALLOC_TYPE == kmalloc_mode) {
		...
		printk(KERN_DEBUG "[FTS]invalid malloc. \n");
		return NULL;
	}
...
void InitStoreParamOfTestData(void)
{
	...
	/*Msg Area, Add Line1 */
	g_lenStoreMsgArea +=
		sprintf(g_pStoreMsgArea, "ECC, 85, 170, IC Name, %s, IC Code, %x\n",

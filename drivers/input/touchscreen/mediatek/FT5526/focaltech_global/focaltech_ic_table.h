...
extern void fts_ic_table_get_ic_name_from_ic_code(unsigned int ic_code,
												  char *strIcName);

extern unsigned int fts_ic_table_get_ic_code_from_chip_id(unsigned char chip_id,
														  unsigned char
														  chip_id2);
extern unsigned int fts_ic_table_get_chip_id_from_ic_code(unsigned int ic_code, unsigned char
														  *chip_id, unsigned char
														  *chip_id2);

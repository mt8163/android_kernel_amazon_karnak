...
static struct cpuidle_driver mt8163_cpuidle_driver = {
	.name             = "mt8163_cpuidle",
	.owner            = THIS_MODULE,
	.states[0] = {
 ...
 */
int __init mt8163_cpuidle_init(void)
{
	int cpu, ret;
	struct cpuidle_driver *drv = &mt8163_cpuidle_driver;
...
int __init mt8163_cpuidle_init(void)
{
	return cpuidle_register(&mt8163_cpuidle_driver, NULL);
}
#endif

device_initcall(mt8163_cpuidle_init);

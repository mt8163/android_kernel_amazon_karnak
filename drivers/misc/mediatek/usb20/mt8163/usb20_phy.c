...
void usb_phy_poweron(void)
{
	...
	/* adjust VRT_VREF_SEL to 780mv, adjust TERM_VREF_SEL to 440mv */
	printk("usb phy poweron read default eye value, Addr: 0x5=0x%x\n", USBPHY_READ8(0x05));
	USBPHY_SET8(0x05, 0x77);
	printk("usb phy poweron read eye value after set,Addr: 0x5=0x%x\n", USBPHY_READ8(0x05));
...
void usb_phy_recover(void)
{
	...
	/* adjust VRT_VREF_SEL to 780mv, adjust TERM_VREF_SEL to 440mv */
	printk("usb phy read default eye value, Addr: 0x5=0x%x\n", USBPHY_READ8(0x05));
	USBPHY_SET8(0x05, 0x77);
	printk("usb phy read eye value after set, Addr: 0x5=0x%x\n", USBPHY_READ8(0X05));

...
/* MDP frame done */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DSC_SOF, 27)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_RDMA0_EOF, 28)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_RSZ0_EOF, 29)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_RSZ1_EOF, 30)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_TDSHP_EOF, 31)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_WDMA_EOF, 32)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_WROT_WRITE_EOF, 33)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MDP_WROT_READ_EOF, 34)

/* Display frame done */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL0_EOF, 35)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_OVL1_EOF, 36)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_RDMA0_EOF, 37)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_RDMA1_EOF, 38)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_WDMA0_EOF, 39)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_COLOR_EOF, 40)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_CCORR_EOF, 41)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_AAL_EOF, 42)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_GAMMA_EOF, 43)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DITHER_EOF, 44)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_UFOE_EOF, 45)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DPI0_EOF, 46)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_WDMA1_EOF, 47)

	DECLARE_CMDQ_EVENT(CMDQ_EVENT_UFOD_RAMA0_L0_EOF, 48)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_UFOD_RAMA0_L1_EOF, 49)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_UFOD_RAMA0_L2_EOF, 50)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_UFOD_RAMA0_L3_EOF, 51)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_UFOD_RAMA1_L0_EOF, 52)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_UFOD_RAMA1_L1_EOF, 53)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_UFOD_RAMA1_L2_EOF, 54)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_UFOD_RAMA1_L3_EOF, 55)

	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DPI1_EOF, 56)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DISP_DSC_EOF, 57)
/* Mutex frame done */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MUTEX0_STREAM_EOF, 58)/* DISPSYS */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MUTEX1_STREAM_EOF, 59)/* DISPSYS */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MUTEX2_STREAM_EOF, 60)/* DISPSYS */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MUTEX3_STREAM_EOF, 61)/* DISPSYS */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MUTEX4_STREAM_EOF, 62)/* DISPSYS, please refer to disp_hal.h */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MUTEX5_STREAM_EOF, 63)/* DpFramework */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MUTEX6_STREAM_EOF, 64)/* DpFramework */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MUTEX7_STREAM_EOF, 65)/* DpFramework */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MUTEX8_STREAM_EOF, 66)/* DpFramework */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_MUTEX9_STREAM_EOF, 67)/* DpFramework via CMDQ_IOCTL_LOCK_MUTEX */
...
/* Display TE */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_DSI_TE, 70)

/* ISP frame done */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_ISP_2_EOF, 130)
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_ISP_1_EOF, 131)

/* ISP engine events */
	DECLARE_CMDQ_EVENT(CMDQ_EVENT_ISP_SENINF1_FULL, 135)

...
bool __init is_charging_mode(void)
{
...
static int boot_mode_proc_show(struct seq_file *p, void *v)
{
	...
	case META_BOOT:
		...
		break;
	case RECOVERY_BOOT:
		seq_puts(p, "RECOVERY BOOT\n");
		break;
	case SW_REBOOT:
		seq_puts(p, "SW REBOOT\n");
		break;
	case FACTORY_BOOT:
		seq_puts(p, "FACTORY BOOT\n");
		break;
	case ADVMETA_BOOT:
	...
	case KERNEL_POWER_OFF_CHARGING_BOOT:
		seq_puts(p, "KPOC BOOT\n");
		break;
	case LOW_POWER_OFF_CHARGING_BOOT:
		seq_puts(p, "LPOC BOOT\n");
		break;
	case DONGLE_BOOT:
		seq_puts(p, "DONGLE BOOT\n");
		break;
	default:

...
typedef enum _ENUM_CMD_ID_T {
	...
	CMD_ID_SET_P2P_CONFIG = 0xa0,	/* 0xa0 (Set) */
...
#endif
#if 1
	CMD_ID_SET_PATTERN_FILTER = 0xEA, /* 0xEA */
	CMD_ID_PATTERN_GENERATOR = 0xEB,
	CMD_ID_TCP_GENERATOR = 0xEC,
#endif
...
struct CMD_TX_PATTERN_GENERATOR {
	enum ENUM_OPCODE_T eOpcode;
	UINT_8 ucPatternIndex;
...
/*TCP PATTERN GENERATOR */
struct CMD_TCP_PATTERN_GENERATOR {
	enum ENUM_OPCODE_T eOpcode;
	UINT_8 ucPatternIndex;
	UINT_32 u4Period;
	UINT_32 u4Timeout;

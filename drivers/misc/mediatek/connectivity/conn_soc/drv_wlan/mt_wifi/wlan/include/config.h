...
#ifdef CONFIG_MTK_WIFI_OOBE_AP_MODE
#define CFG_SUPPORT_OOBE_AP_MODE            1
#else
 ...
 *------------------------------------------------------------------------------
 */
#define CFG_SHOW_NVRAM						1
#define OFFSET_aucEfuse					0x34
#define OFFSET_fg5GBandEdgePwrUsed		(0x3E - OFFSET_aucEfuse)
#define OFFSET_c5GBandEdgeMaxPwrOFDM20	(0x3F - OFFSET_aucEfuse)
#define OFFSET_c5GBandEdgeMaxPwrOFDM40	(0x40 - OFFSET_aucEfuse)
#define OFFSET_aucChOffset				(0x50 - OFFSET_aucEfuse)
#define OFFSET_ucChannelOffsetValid		(0x53 - OFFSET_aucEfuse)
#define OFFSET_acAllChannelOffset		(0x54 - OFFSET_aucEfuse)
#define OFFSET_auc5GChOffset			(0x60 - OFFSET_aucEfuse)
#define OFFSET_uc5GChannelOffsetValid	(0x68 - OFFSET_aucEfuse)

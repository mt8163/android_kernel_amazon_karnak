...
#define COMBO_IOCTL_BT_IC_HW_VER    _IOR(COMBO_IOC_MAGIC, 1, void*)
#define COMBO_IOCTL_BT_IC_FW_VER    _IOR(COMBO_IOC_MAGIC, 2, void*)
#define COMBO_IOC_BT_HWVER          _IOR(COMBO_IOC_MAGIC, 3, void*)

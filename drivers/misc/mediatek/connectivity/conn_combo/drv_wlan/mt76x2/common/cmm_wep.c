...
/*
	...
	========================================================================
*/
static VOID RTMPInitWepEngine(IN PUCHAR pIv,
			      IN PUCHAR pKey, IN UCHAR KeyLen, OUT ARC4_CTX_STRUC *pARC4_CTX)
{
	PUCHAR seed = NULL;
	UINT8 seed_len;
			   ...
			   IN PCIPHER_KEY pKey, INOUT PUCHAR pData, IN ULONG DataByteCnt)
{
	...
	RTMPInitWepEngine(pIvHdr, pKey->Key, pKey->KeyLen, ARC4_CTX);
			   ...
			   IN PCIPHER_KEY pKey, INOUT PUCHAR pData, INOUT UINT16 *DataByteCnt)
{
	...
	/* Initialize WEP key stream */
	RTMPInitWepEngine(pData, pKey->Key, pKey->KeyLen, ARC4_CTX);

...
inline CHAR GetFrequencyOffsetField(PRTMP_ADAPTER pAd, RXWI_STRUCT *pRxWI, UINT8 RxWIFrqOffsetField)
{
	CHAR FreqOffset = 0;
...
CHAR GetFrequencyOffset(IN PRTMP_ADAPTER pAd, IN RXWI_STRUCT *pRxWI)
{
	CHAR FreqOffset = 0;

...
========================================================================
*/
TDLS_UAPSD_EXTERN BOOLEAN TDLS_UAPSDP_Init(IN PRTMP_ADAPTER pAd, IN STATE_MACHINE *pFSM);
...
========================================================================
*/
TDLS_UAPSD_EXTERN BOOLEAN TDLS_UAPSDP_Release(IN PRTMP_ADAPTER pAd);
...
========================================================================
*/
TDLS_UAPSD_EXTERN NDIS_STATUS TDLS_UAPSDP_TrafficIndSend(IN PRTMP_ADAPTER pAd, IN UCHAR *pPeerMac);
...
========================================================================
*/
TDLS_UAPSD_EXTERN BOOLEAN TDLS_UAPSDP_AsicCanSleep(IN PRTMP_ADAPTER pAd);
...
========================================================================
*/
VOID TDLS_UAPSDP_PsmModeChange(IN PRTMP_ADAPTER pAd, IN USHORT PsmOld, IN USHORT PsmNew);
...
========================================================================
*/
TDLS_UAPSD_EXTERN INT TDLS_Ioctl(IN PRTMP_ADAPTER pAd, IN PSTRING pArgvIn);
...
========================================================================
*/
TDLS_UAPSD_EXTERN INT Set_TdlsUapsdProc(IN PRTMP_ADAPTER pAd, IN PSTRING pArgvIn);

...
#define RT_CFG80211_LOST_GO_INFORM(__pAd, _Reason) \
	CFG80211_LostP2pGoInform((VOID *)__pAd, _Reason);
...
#define TXS_TIMEOUT  60		/*timeout for txs cmd */
#define TXS_P2P_MgmtID  0
#define TXS_P2P_WCID  2

BOOLEAN CFG80211_IsNeedTxStatus(IN VOID *pAdOrg, IN UCHAR *pFrame, IN UINT32 FrameLength);

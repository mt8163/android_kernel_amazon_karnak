...
VOID dump_rtmp_rxwi(struct _RTMP_ADAPTER *pAd, union _RXWI_STRUCT *pRxWI);
VOID dump_rtmp_txwi(struct _RTMP_ADAPTER *pAd, union _TXWI_STRUCT *pTxWI);
VOID dump_rtmp_rxinfo(struct _RTMP_ADAPTER *pAd, struct _RXINFO_STRUCT *pRxInfo);

INT rtmp_get_rxwi_phymode(union _RXWI_STRUCT *rxwi);
INT rtmp_get_rxwi_rssi(union _RXWI_STRUCT *rxwi, INT size, CHAR *rssi);
INT rtmp_get_rxwi_snr(union _RXWI_STRUCT *rxwi, INT size, UCHAR *snr);

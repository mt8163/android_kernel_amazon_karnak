...
#define OID_CURRENT_ASSOCIATED_BW       0x06B4
#define OID_GET_P2P_NOA                   0x06B5	/* Get p2p noa attribute */
#define OID_SET_MCC                   0x06B6	/* Set MCC Enable */
#define OID_GET_ACS_RANK_LIST           0x06B7	/* Get AutoChannelSelection Rank list */

#ifdef CUSTOMIZED_FEATURE_SUPPORT
#define OID_CUSTOMIZED_FEATURE_ENABLE	0x06B8
#endif /* CUSTOMIZED_FEATURE_SUPPORT */

#ifdef HE_TV_SUPPORT
#define OID_BW_CAPABILITY				0x06B0
#define RT_OID_BW_CAPABILITY		    (OID_GET_SET_TOGGLE | OID_BW_CAPABILITY)
...
#define OID_HE_CANCEL_SCAN					0x06C6

...
typedef enum _CMD_RTPRIV_IOCTL_AP {
	...
	CMD_RTPRIV_IOCTL_META_QUERY,
	CMD_RTPRIV_IOCTL_META_SET,
...
typedef enum _CMD_RTPRIV_IOCTL_COMMON {
	...
	CMD_RTPRIV_IOCTL_ADAPTER_RT28XX_INFRA_STATUS,
	CMD_RTPRIV_IOCTL_ADAPTER_RT28XX_WOW_RUNSTATUS,
#endif /* (defined(WOW_SUPPORT) && defined(RTMP_MAC_USB)) || defined(NEW_WOW_SUPPORT) */
	CMD_RTPRIV_IOCTL_ADAPTER_RT28XX_CMD_RADIO_OFF,
	CMD_RTPRIV_IOCTL_ADAPTER_RT28XX_CMD_RADIO_ON,
	...
	CMD_RTPRIV_IOCTL_80211_IBSS_JOIN,	/* GeK: obsoleted */
	CMD_RTPRIV_IOCTL_80211_STA_LEAVE,
	CMD_RTPRIV_IOCTL_80211_STA_GET,	/* GeK: obsoleted */
	...
	CMD_RTPRIV_IOCTL_80211_PORT_SECURED,	/* GeK: obsoleted */
	CMD_RTPRIV_IOCTL_80211_AP_STA_DEL,	/* GeK: obsoleted */
	...
	CMD_RTPRIV_IOCTL_80211_P2PCLI_ASSSOC_IE_SET,	/* GeK: obsoleted */
...
#define RT_CMD_80211_IFTYPE_P2P_DEVICE          0x0a
...
typedef struct __CMD_IOCTL_80211_STA_INFO {
	ULONG DataRate;
...
typedef enum _CMD_RTPRIV_IOCTL_STATION {
	...
	CMD_RTPRIV_IOCTL_STA_SIOCSIWGENIE,	/* GeK: obsoleted */
	CMD_RTPRIV_IOCTL_STA_SIOCGIWGENIE,
	CMD_RTPRIV_IOCTL_STA_SIOCSIWPMKSA,	/* GeK: obsoleted */
...
#ifdef WCX_SUPPORT
	CMD_RTPRIV_IOCTL_STA_META_SET,
	CMD_RTPRIV_IOCTL_STA_META_QUERY,
#endif /* endif */
...
typedef struct __RT_CMD_CFG80211_CONFIG {
	IN VOID *pCfgDev;
	IN VOID(*CFG80211_Register) (IN VOID *pAd, IN VOID *pDev, IN VOID *pNetDev);
...
typedef struct _MESH_SCAN_INFO_STRUCT_ {
	UCHAR fgIsMeshNet;
	UCHAR fgIsRootMesh;
	...
	UCHAR HostNameLen;
} MESH_SCAN_INFO_STRUCT, *PMESH_SCAN_INFO_STRUCT;
...
#define RT_CMD_STA_IOCTL_SECURITY_ALG_KCK		0x05
#define RT_CMD_STA_IOCTL_SECURITY_ALG_KEK		0x06

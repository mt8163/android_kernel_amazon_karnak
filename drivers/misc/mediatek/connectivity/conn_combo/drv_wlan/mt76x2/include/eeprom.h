...
#define EXTERN_COMPONENT_SETTING_1 0x23
#define EXTERN_COMPONENT_SETTING_2 0x24
#define EXTERN_COMPONENT_SETTING_3 0x25
...
/*************************************************************************
  ...
  ************************************************************************/
NTSTATUS RTUSBReadEEPROM16(IN struct _RTMP_ADAPTER *pAd, IN USHORT offset, OUT PUSHORT pData);

NTSTATUS RTUSBWriteEEPROM16(IN struct _RTMP_ADAPTER *pAd, IN USHORT offset, IN USHORT value);
...
/*************************************************************************
  ...
  ************************************************************************/
NDIS_STATUS rtmp_nv_init(IN struct _RTMP_ADAPTER *pAd);

int rtmp_ee_flash_read(IN struct _RTMP_ADAPTER *pAd, IN USHORT Offset, OUT USHORT *pValue);

int rtmp_ee_flash_write(IN struct _RTMP_ADAPTER *pAd, IN USHORT Offset, IN USHORT Data);

VOID rtmp_ee_flash_read_all(IN struct _RTMP_ADAPTER *pAd, IN USHORT *Data);

VOID rtmp_ee_flash_write_all(IN struct _RTMP_ADAPTER *pAd, IN USHORT *Data);
...
/*************************************************************************
  ...
  ************************************************************************/
int rtmp_ee_efuse_read16(IN struct _RTMP_ADAPTER *pAd, IN USHORT Offset, OUT USHORT *pValue);

int rtmp_ee_efuse_write16(IN struct _RTMP_ADAPTER *pAd, IN USHORT Offset, IN USHORT data);

INT rtmp_ee_write_to_efuse(IN struct _RTMP_ADAPTER *pAd);
#endif /* RTMP_EFUSE_SUPPORT */

/*************************************************************************
  *	Public function declarations for using BIN buffer mode to access eeprom contents
  ************************************************************************/
INT rtmp_ee_bin_read16(IN struct _RTMP_ADAPTER *pAd, IN USHORT Offset, OUT USHORT *pValue);

INT rtmp_ee_bin_write16(IN struct _RTMP_ADAPTER *pAd, IN USHORT Offset, IN USHORT data);
...
#ifdef RT65xx
INT rtmp_ee_write_to_prom(IN struct _RTMP_ADAPTER *pAd);
#endif /* RT65xx */

INT Set_LoadEepromBufferFromBin_Proc(IN struct _RTMP_ADAPTER *pAd, IN PSTRING arg);

INT Set_EepromBufferWriteBack_Proc(IN struct _RTMP_ADAPTER *pAd, IN PSTRING arg);
...
BOOLEAN rtmp_get_default_bin_file_by_chip(struct _RTMP_ADAPTER *pAd, UINT32 ChipVersion,
					  PSTRING *pBinFileName);

INT rtmp_ee_load_from_default(struct _RTMP_ADAPTER *pAd);
#endif /* __EEPROM_H__ */

...
#define PTA_CNT_BT1 0x0160
#define PTA_CNT_BT2 0x0164
...
#define COEX_STA_CNT0 0x1258
#define COEX_STA_CNT1 0x125c
#define DACCLK_EN_DLY_CFG	0x1264
#define BT_COEX_CFG_9	0x126c
#define BT_COEX_CFG_9_UPDATE_CNT (1 << 17)
#define BT_COEX_CFG_13 0x127c
...
struct _RXINFO_STRUCT;
union _TXINFO_STRUCT;
union _TXWI_STRUCT;
union _RXWI_STRUCT;

VOID dump_rlt_rxinfo(struct _RTMP_ADAPTER *pAd, struct _RXINFO_STRUCT *pRxInfo);
VOID dump_rlt_txinfo(struct _RTMP_ADAPTER *pAd, union _TXINFO_STRUCT *pTxInfo);
VOID dump_rlt_txwi(struct _RTMP_ADAPTER *pAd, union _TXWI_STRUCT *pTxWI);
VOID dump_rlt_rxwi(struct _RTMP_ADAPTER *pAd, union _RXWI_STRUCT *pRxWI);
VOID dumpRxFCEInfo(struct _RTMP_ADAPTER *pAd, RXFCE_INFO *pRxFceInfo);

INT rlt_get_rxwi_phymode(union _RXWI_STRUCT *rxwi);
INT rlt_get_rxwi_rssi(union _RXWI_STRUCT *rxwi, INT size, CHAR *rssi);
INT rlt_get_rxwi_snr(struct _RTMP_ADAPTER *pAd, union _RXWI_STRUCT *rxwi, INT size, UCHAR *snr);
...
#ifdef RTMP_MAC_USB
VOID rlt_usb_write_txinfo(IN struct _RTMP_ADAPTER *pAd,
			  IN union _TXINFO_STRUCT *pTxInfo,

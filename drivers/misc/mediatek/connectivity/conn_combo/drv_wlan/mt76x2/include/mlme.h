...
#define SCAN_CHANNEL_COUNT 7
#define SHORT_SCAN_CHANNEL_COUNT 1
#define SCAN_ONLINE 1/*online scan, op ch time OP_CHANNEL_TIME, scan time FAST_ACTIVE_SCAN_TIME*/
#if SCAN_ONLINE
#define OP_CHANNEL_TIME 100
#else
#define OP_CHANNEL_TIME 0
#endif
...
#define DRS_TX_QUALITY_WORST_BOUND       4	/* 3  // just test by gary */
...
#ifdef CONFIG_AP_SUPPORT
#ifdef APCLI_SUPPORT
typedef VOID(*APCLI_STATE_MACHINE_FUNC) (VOID *pAd, MLME_QUEUE_ELEM *Elem, PULONG pCurrState,
					 USHORT ifIndex);

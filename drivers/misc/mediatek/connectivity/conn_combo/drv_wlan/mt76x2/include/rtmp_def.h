...
#ifdef MULTI_URB
#ifdef WEBOS_SUPPORT
#define SUBMIT_URB_NUM          2
#else /* WEBOS_SUPPORT */
#define SUBMIT_URB_NUM          4
#endif /* WEBOS_SUPPORT */
#endif /* MULTI_URB */
...
#define WMM_NUM_OF_AC                       5	/* AC0, AC1, AC2, and AC3 */
#else
...
/* 7662 use wmode,always set phymode false */
#define PHYMODE_CAP_N(_x)       (0)
...
#define REASON_DRIVER_DEFAULT				0xff
...
#ifdef WEBOS_SUPPORT
#define BUF_ALIGMENT_RINGSIZE         3	/*BUF_ALIGMENT_RINGSIZE must  >= 3 */
#else /* !WEBOS_SUPPORT */
#define BUF_ALIGMENT_RINGSIZE         14 /*BUF_ALIGMENT_RINGSIZE must  >= 3 */
#endif /* WEBOS_SUPPORT */
...
#define REGION_8_BG_BAND                  (8)
#define REGION_9_BG_BAND                  (9)
#define REGION_10_BG_BAND                 (10)
#define REGION_11_BG_BAND                 (11)
#define REGION_12_BG_BAND                 (12)
#define REGION_13_BG_BAND                 (13)
#define REGION_14_BG_BAND                 (14)
#define REGION_15_BG_BAND                 (15)
#define REGION_31_BG_BAND                 31	/* 5-13 */
#define REGION_32_BG_BAND                 32	/* 1 - 13 */
#define REGION_33_BG_BAND                 33	/* 1 - 14 */
#ifdef CUSTOMIZED_COUNTRY_REGION_CE_1
#define REGION_MAXIMUM_BG_BAND            15
...
#ifdef CUSTOMIZED_COUNTRY_REGION_CE_1
#define SINGLESKU_TAB_0                     0
#define SINGLESKU_TAB_1                     1
#define SINGLESKU_TAB_2                     2
#define SINGLESKU_TAB_3                     3
#define SINGLESKU_TAB_4                     4
#define SINGLESKU_TAB_5                     5
#define SINGLESKU_TAB_6                     6
#define SINGLESKU_TAB_7                     7
#define SINGLESKU_TAB_8                     8
#endif /* CUSTOMIZED_COUNTRY_REGION_CE_1 */

...
void rtmp_read_pmf_parameters_from_file(IN PRTMP_ADAPTER pAd,
					IN PSTRING tmpbuf, IN PSTRING pBuffer);

INT Set_PMFMFPC_Proc(IN PRTMP_ADAPTER pAd, IN PCHAR arg);

INT Set_PMFMFPR_Proc(IN PRTMP_ADAPTER pAd, IN PCHAR arg);

INT Set_PMFSHA256_Proc(IN PRTMP_ADAPTER pAd, IN PCHAR arg);

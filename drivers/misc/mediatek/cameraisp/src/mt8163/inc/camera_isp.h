...
enum ISP_HOLD_TIME_ENUM { ISP_HOLD_TIME_VD, ISP_HOLD_TIME_EXPDONE };
...
#define ISP_SENSOR_FREQ_CTRL                                                   \
	_IOW(ISP_MAGIC, ISP_CMD_SENSOR_FREQ_CTRL, unsigned long)
...
#define COMPAT_ISP_SET_USER_PID                                                \
	_IOW(ISP_MAGIC, ISP_CMD_SET_USER_PID, compat_uptr_t)
...
#define COMPAT_ISP_SENSOR_FREQ_CTRL                                            \
	_IOW(ISP_MAGIC, ISP_CMD_SENSOR_FREQ_CTRL, compat_uptr_t)
#endif

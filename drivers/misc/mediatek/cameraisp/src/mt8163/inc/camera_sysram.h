...
/*  */
enum SYSRAM_CMD_ENUM { SYSRAM_CMD_ALLOC, SYSRAM_CMD_FREE, SYSRAM_CMD_DUMP };
 ...
 */
#define SYSRAM_ALLOC                                                           \
	_IOWR(SYSRAM_MAGIC_NO, SYSRAM_CMD_ALLOC, struct SYSRAM_ALLOC_STRUCT)
#define SYSRAM_FREE                                                            \
	_IOWR(SYSRAM_MAGIC_NO, SYSRAM_CMD_FREE, enum SYSRAM_USER_ENUM)
#define SYSRAM_DUMP _IO(SYSRAM_MAGIC_NO, SYSRAM_CMD_DUMP)

#ifdef CONFIG_COMPAT
#define COMPAT_SYSRAM_ALLOC                                                    \
	_IOWR(SYSRAM_MAGIC_NO, SYSRAM_CMD_ALLOC,                               \
	      struct compat_SYSRAM_ALLOC_STRUCT)
#define COMPAT_SYSRAM_FREE                                                     \
	_IOWR(SYSRAM_MAGIC_NO, SYSRAM_CMD_FREE, enum compat_SYSRAM_USER_ENUM)
#endif
/* -----------------------------------------------------------------------------
 */
#endif

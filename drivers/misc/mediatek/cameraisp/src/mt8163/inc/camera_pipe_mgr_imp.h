...
#define CAM_PIPE_MGR_LOCK_TABLE_IC                                             \
	((1 << CAM_PIPE_MGR_PIPE_CAM_IO) | (1 << CAM_PIPE_MGR_PIPE_POST_PROC))
#define CAM_PIPE_MGR_LOCK_TABLE_VR                                             \
	((1 << CAM_PIPE_MGR_PIPE_CAM_IO) | (1 << CAM_PIPE_MGR_PIPE_XDP_CAM))
#define CAM_PIPE_MGR_LOCK_TABLE_ZSD                                            \
	((1 << CAM_PIPE_MGR_PIPE_CAM_IO) | (1 << CAM_PIPE_MGR_PIPE_XDP_CAM))
#define CAM_PIPE_MGR_LOCK_TABLE_IP ((1 << CAM_PIPE_MGR_PIPE_POST_PROC))
#define CAM_PIPE_MGR_LOCK_TABLE_N3D                                            \
	((1 << CAM_PIPE_MGR_PIPE_CAM_IO) | (1 << CAM_PIPE_MGR_PIPE_POST_PROC))
#define CAM_PIPE_MGR_LOCK_TABLE_VSS                                            \
	((1 << CAM_PIPE_MGR_PIPE_CAM_IO) | (1 << CAM_PIPE_MGR_PIPE_POST_PROC))
/* -----------------------------------------------------------------------------
 */

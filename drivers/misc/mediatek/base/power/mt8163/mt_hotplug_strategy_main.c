...
{
	if (toUart) {
		hps_info("hps_ctxt.init_state: %u\n", hps_ctxt.init_state);
		hps_info("hps_ctxt.state: %u\n", hps_ctxt.state);
		hps_info("hps_ctxt.enabled: %u\n", hps_ctxt.enabled);
		hps_info("hps_ctxt.early_suspend_enabled: %u\n",
			hps_ctxt.early_suspend_enabled);
		hps_info("hps_ctxt.suspend_enabled: %u\n",
			hps_ctxt.suspend_enabled);
		hps_info("hps_ctxt.is_hmp: %u\n", hps_ctxt.is_hmp);
		hps_info("hps_ctxt.little_cpu_id_min: %u\n",
			hps_ctxt.little_cpu_id_min);
		hps_info("hps_ctxt.little_cpu_id_max: %u\n",
			hps_ctxt.little_cpu_id_max);
		hps_info("hps_ctxt.big_cpu_id_min: %u\n",
			hps_ctxt.big_cpu_id_min);
		hps_info("hps_ctxt.big_cpu_id_max: %u\n",
...
{
	if (toUart) {
		hps_info("hps_ctxt.up_threshold: %u\n", hps_ctxt.up_threshold);
		hps_info("hps_ctxt.up_times: %u\n", hps_ctxt.up_times);
		hps_info("hps_ctxt.down_threshold: %u\n",
			hps_ctxt.down_threshold);
		hps_info("hps_ctxt.down_times: %u\n", hps_ctxt.down_times);
		hps_info("hps_ctxt.input_boost_enabled: %u\n",
			hps_ctxt.input_boost_enabled);
		hps_info("hps_ctxt.input_boost_cpu_num: %u\n",
			hps_ctxt.input_boost_cpu_num);
		hps_info("hps_ctxt.rush_boost_enabled: %u\n",
			hps_ctxt.rush_boost_enabled);
		hps_info("hps_ctxt.rush_boost_threshold: %u\n",
			hps_ctxt.rush_boost_threshold);
		hps_info("hps_ctxt.rush_boost_times: %u\n",
			hps_ctxt.rush_boost_times);
		hps_info("hps_ctxt.tlp_times: %u\n", hps_ctxt.tlp_times);
	} else {
...
{
	if (toUart) {
		hps_info("hps_ctxt.little_num_base_perf_serv: %u\n",
			hps_ctxt.little_num_base_perf_serv);
		hps_info("hps_ctxt.little_num_limit_thermal: %u\n",
			hps_ctxt.little_num_limit_thermal);
		hps_info("hps_ctxt.little_num_limit_low_battery: %u\n",
			hps_ctxt.little_num_limit_low_battery);
		hps_info("hps_ctxt.little_num_limit_ultra_power_saving: %u\n",
			hps_ctxt.little_num_limit_ultra_power_saving);
		hps_info("hps_ctxt.little_num_limit_power_serv: %u\n",
			hps_ctxt.little_num_limit_power_serv);
		hps_info("hps_ctxt.big_num_base_perf_serv: %u\n",
			hps_ctxt.big_num_base_perf_serv);
		hps_info("hps_ctxt.big_num_limit_thermal: %u\n",
			hps_ctxt.big_num_limit_thermal);
		hps_info("hps_ctxt.big_num_limit_low_battery: %u\n",
			hps_ctxt.big_num_limit_low_battery);
		hps_info("hps_ctxt.big_num_limit_ultra_power_saving: %u\n",
			hps_ctxt.big_num_limit_ultra_power_saving);
		hps_info("hps_ctxt.big_num_limit_power_serv: %u\n",
...
{
	if (toUart) {
		hps_info("hps_ctxt.cur_loads: %u\n", hps_ctxt.cur_loads);
		hps_info("hps_ctxt.cur_tlp: %u\n", hps_ctxt.cur_tlp);
		hps_info("hps_ctxt.cur_iowait: %u\n", hps_ctxt.cur_iowait);
		hps_info("hps_ctxt.cur_nr_heavy_task: %u\n",
...
{
	if (toUart) {
		hps_info("hps_ctxt.up_loads_sum: %u\n", hps_ctxt.up_loads_sum);
		hps_info("hps_ctxt.up_loads_count: %u\n",
			hps_ctxt.up_loads_count);
		hps_info("hps_ctxt.up_loads_history_index: %u\n",
...
{
	if (toUart) {
		hps_info("hps_ctxt.down_loads_sum: %u\n",
			hps_ctxt.down_loads_sum);
		hps_info("hps_ctxt.down_loads_count: %u\n",
			hps_ctxt.down_loads_count);
		hps_info("hps_ctxt.down_loads_history_index: %u\n",
...
{
	if (toUart) {
		hps_info("hps_ctxt.tlp_sum: %u\n", hps_ctxt.tlp_sum);
		hps_info("hps_ctxt.tlp_count: %u\n", hps_ctxt.tlp_count);
		hps_info("hps_ctxt.tlp_history_index: %u\n",
			hps_ctxt.tlp_history_index);
		hps_info("hps_ctxt.tlp_avg: %u\n", hps_ctxt.tlp_avg);
		hps_info("hps_ctxt.rush_count: %u\n", hps_ctxt.rush_count);
	} else {

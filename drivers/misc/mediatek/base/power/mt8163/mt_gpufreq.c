...
static unsigned int _mt_gpufreq_get_dvfs_table_type(void)
{
	...
	mt_gpufreq_dvfs_mmpll_spd_bond = (get_devinfo_with_index(GPUFREQ_EFUSE_INDEX) >> 20) & 0xf;
...
static void _mt_gpufreq_set_initial(void)
{
	...
	_mt_gpufreq_set(cur_freq, mt_gpufreqs[g_cur_gpu_OPPidx].gpufreq_khz, g_cur_gpu_OPPidx);
...
static int _mt_gpufreq_pdrv_probe(struct platform_device *pdev)
{
	...
	/**********************
	* Initial leackage power usage: TODO
	***********************/
	/* mt_spower_init(); */

...
#include "../../accelerometer/bmi160_acc/bmi160_acc.h"

#define BMG_DRIVER_VERSION "V1.0"

#define BMI160_GYRO_DEBUG 0
#define GYRO_FLAG					"<GYRO> "
#define GYRO_FUNC(f)       pr_debug(GYRO_FLAG"%s\n", __func__)
#define GYRO_ERROR(fmt, args...)	pr_err(GYRO_FLAG"%s %d : "fmt, __func__, __LINE__, ##args)
#if BMI160_GYRO_DEBUG
...
/* BMI160_FS_MAX_LSB is used as a multiple*/
#define BMI160_FS_MAX_LSB			131

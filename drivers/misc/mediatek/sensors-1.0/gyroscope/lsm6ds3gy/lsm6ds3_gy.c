...
static int LSM6DS3_ReadGyroData(struct i2c_client *client, char *buf, int bufsize)
{
    ...
    if (hwmsen_read_block(client, LSM6DS3_OUTX_L_G, databuf, 6)) {
        ...
        offset[0] = gyro_xyz_offset[0];
        offset[1] = gyro_xyz_offset[1];
        offset[2] = gyro_xyz_offset[2];

        offset[0] = (long)(offset[LSM6DS3_AXIS_X])*LSM6DS3_GYRO_SENSITIVITY_2000DPS*131/1000/1000;
        offset[1] = (long)(offset[LSM6DS3_AXIS_Y])*LSM6DS3_GYRO_SENSITIVITY_2000DPS*131/1000/1000;
        offset[2] = (long)(offset[LSM6DS3_AXIS_Z])*LSM6DS3_GYRO_SENSITIVITY_2000DPS*131/1000/1000;

...
#define X_CON_SCE(con_sce, arba, arbb, arbc, arbd, arbe, arbf, arbg, arbg2, arbh) (#con_sce),
...
#define X_CON_SCE(con_sce, arba, arbb, arbc, arbd, arbe, arbf, arbg, arbg2, arbh) arba,
#include "mach/con_sce_lpddr2_1066.h"
#undef X_CON_SCE
};

static const unsigned int emi_arbb_lpddr2_1066_val[] = {
#define X_CON_SCE(con_sce, arba, arbb, arbc, arbd, arbe, arbf, arbg, arbg2, arbh) arbb,
#include "mach/con_sce_lpddr2_1066.h"
#undef X_CON_SCE
};

static const unsigned int emi_arbc_lpddr2_1066_val[] = {
#define X_CON_SCE(con_sce, arba, arbb, arbc, arbd, arbe, arbf, arbg, arbg2, arbh) arbc,
#include "mach/con_sce_lpddr2_1066.h"
#undef X_CON_SCE
};

static const unsigned int emi_arbd_lpddr2_1066_val[] = {
#define X_CON_SCE(con_sce, arba, arbb, arbc, arbd, arbe, arbf, arbg, arbg2, arbh) arbd,
#include "mach/con_sce_lpddr2_1066.h"
#undef X_CON_SCE
};

static const unsigned int emi_arbe_lpddr2_1066_val[] = {
#define X_CON_SCE(con_sce, arba, arbb, arbc, arbd, arbe, arbf, arbg, arbg2, arbh) arbe,
#include "mach/con_sce_lpddr2_1066.h"
#undef X_CON_SCE
};

static const unsigned int emi_arbf_lpddr2_1066_val[] = {
#define X_CON_SCE(con_sce, arba, arbb, arbc, arbd, arbe, arbf, arbg, arbg2, arbh) arbf,
#include "mach/con_sce_lpddr2_1066.h"
#undef X_CON_SCE
};

static const unsigned int emi_arbg_lpddr2_1066_val[] = {
#define X_CON_SCE(con_sce, arba, arbb, arbc, arbd, arbe, arbf, arbg, arbg2, arbh) arbg,
#include "mach/con_sce_lpddr2_1066.h"
#undef X_CON_SCE
};

static const unsigned int emi_arbg2_lpddr2_1066_val[] = {
#define X_CON_SCE(con_sce, arba, arbb, arbc, arbd, arbe, arbf, arbg, arbg2, arbh) arbg2,
#include "mach/con_sce_lpddr2_1066.h"
#undef X_CON_SCE
};

static const unsigned int emi_arbh_lpddr2_1066_val[] = {
#define X_CON_SCE(con_sce, arba, arbb, arbc, arbd, arbe, arbf, arbg, arbg2, arbh) arbh,
#include "mach/con_sce_lpddr2_1066.h"
#undef X_CON_SCE
};
...
int mtk_mem_bw_ctrl(int sce, int op)
{
	...
	if (highest != cur_con_sce) {
		if (get_dram_type() == LPDDR3_1600) {
			...
			writel(emi_arbg_lpddr3_1600_val[highest], EMI_ARBG);
			writel(emi_arbg2_lpddr3_1600_val[highest], EMI_ARBG_2ND);
			...
			writel(emi_arbg_lpddr2_1066_val[highest], EMI_ARBG);
			writel(emi_arbg2_lpddr2_1066_val[highest], EMI_ARBG_2ND);
			mt_reg_sync_writel(emi_arbh_lpddr2_1066_val[highest], EMI_ARBH);
		}
		cur_con_sce = highest;
	}

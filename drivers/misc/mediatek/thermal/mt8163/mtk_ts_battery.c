...
trip_temp[0], trip_temp[1]);
	seq_printf(m, "trip_2_temp=%d,trip_3_temp=%d,trip_4_temp=%d,trip_5_temp=%d\n",
trip_temp[2], trip_temp[3], trip_temp[4], trip_temp[5]);
	seq_printf(m, "trip_6_temp=%d,trip_7_temp=%d,trip_8_temp=%d,trip_9_temp=%d\n",
...
g_THERMAL_TRIP[0], g_THERMAL_TRIP[1], g_THERMAL_TRIP[2]);
	seq_printf(m, "g_THERMAL_TRIP_3=%d,g_THERMAL_TRIP_4=%d,g_THERMAL_TRIP_5=%d,\n",
g_THERMAL_TRIP[3], g_THERMAL_TRIP[4], g_THERMAL_TRIP[5]);
	seq_printf(m, "g_THERMAL_TRIP_6=%d,g_THERMAL_TRIP_7=%d,g_THERMAL_TRIP_8=%d,g_THERMAL_TRIP_9=%d,\n",
...
g_THERMAL_TRIP[8], g_THERMAL_TRIP[9]);
		mtktsbattery_dprintk("[mtktsbattery_write] cooldev0=%s,cooldev1=%s,", g_bind0, g_bind1);
		mtktsbattery_dprintk("cooldev2=%s,cooldev3=%s,cooldev4=%s,cooldev5=%s,",
g_bind2, g_bind3, g_bind4, g_bind5);
		mtktsbattery_dprintk("cooldev6=%s,cooldev7=%s,cooldev8=%s,cooldev9=%s\n",
g_bind6, g_bind7, g_bind8, g_bind9);
		...
		mtktsbattery_dprintk("[mtktsbattery_write] trip_0_temp=%d,trip_1_temp=%d,",
trip_temp[0], trip_temp[1]);
		mtktsbattery_dprintk("trip_2_temp=%d,trip_3_temp=%d,trip_4_temp=%d,",
trip_temp[2], trip_temp[3], trip_temp[4]);
		mtktsbattery_dprintk("trip_5_temp=%d,trip_6_temp=%d,trip_7_temp=%d,",

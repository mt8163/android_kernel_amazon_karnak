...
static int tsallts_get_temp1(struct thermal_zone_device *thermal, int *t)
{
...
static int tsallts_get_temp5(struct thermal_zone_device *thermal, int *t)
{
#if MTK_ALLTS_SW_FILTER == 1
	int curr_temp;
	int temp_temp;
...
static int tsallts_get_temp3(struct thermal_zone_device *thermal, int *t)
{
#if MTK_ALLTS_SW_FILTER == 1
	int curr_temp;
	int temp_temp;
...
static int tsallts_get_temp4(struct thermal_zone_device *thermal, int *t)
{
#if MTK_ALLTS_SW_FILTER == 1
	int curr_temp;
	int temp_temp;
	...
	struct thermal_cooling_device *cdev)
{
	...
	if (thermal_zone_unbind_cooling_device(thermal, table_val, cdev)) {
		tsallts_dprintk(
			"[tsallts_unbind] error unbinding cooling dev\n");
		return -EINVAL;
	}
...
static int tsallts_get_trip_type(struct thermal_zone_device *thermal,
...
static int tsallts_get_trip_temp(struct thermal_zone_device *thermal,
	int trip, int *temp)
{
	*temp = trip_temp[trip];
	return 0;
...
static int tsallts_set_trip_temp(struct thermal_zone_device *thermal,
	int trip, int temp)
{
	trip_temp[trip] = temp;
	return 0;
...
static int tsallts_read1(struct seq_file *m, void *v)
{
	...
	seq_printf(m,
	"[ tsallts_read1] trip_0_temp=%d,trip_1_temp=%d,trip_2_temp=%d,trip_3_temp=%d,trip_4_temp=%d,\n",
...
g_THERMAL_TRIP[0], g_THERMAL_TRIP[1], g_THERMAL_TRIP[2], g_THERMAL_TRIP[3]);
	seq_printf(m,
	"g_THERMAL_TRIP_4=%d,g_THERMAL_TRIP_5=%d,g_THERMAL_TRIP_6=%d,\n",
...
static int tsallts_read5(struct seq_file *m, void *v)
{
	...
	seq_printf(m,
	"[ tsallts_read5] trip_0_temp=%d,trip_1_temp=%d,trip_2_temp=%d,trip_3_temp=%d,trip_4_temp=%d,\n",
trip_temp[0], trip_temp[1], trip_temp[2], trip_temp[3], trip_temp[4]);
	seq_printf(m,
	"trip_5_temp=%d,trip_6_temp=%d,trip_7_temp=%d,trip_8_temp=%d,trip_9_temp=%d,\n",
trip_temp[5], trip_temp[6], trip_temp[7], trip_temp[8], trip_temp[9]);
...
static int tsallts_read3(struct seq_file *m, void *v)
{
	...
	seq_printf(m,
	"[ tsallts_read3] trip_0_temp=%d,trip_1_temp=%d,trip_2_temp=%d,trip_3_temp=%d,trip_4_temp=%d,\n",
	trip_temp[0], trip_temp[1], trip_temp[2], trip_temp[3], trip_temp[4]);
	seq_printf(m,
	"trip_5_temp=%d,trip_6_temp=%d,trip_7_temp=%d,trip_8_temp=%d,trip_9_temp=%d,\n",
	trip_temp[5], trip_temp[6], trip_temp[7], trip_temp[8], trip_temp[9]);
...
static int tsallts_read4(struct seq_file *m, void *v)
{
	...
	seq_printf(m,
	"[ tsallts_read4] trip_0_temp=%d,trip_1_temp=%d,trip_2_temp=%d,trip_3_temp=%d,trip_4_temp=%d,\n",
...
static ssize_t tsallts_write1(struct file *file, const char __user *buffer,
	size_t count, loff_t *data)
{
	...
	if (sscanf(desc,
		...
		tsallts_dprintk(
		"[tsallts_write1] g_THERMAL_TRIP_0=%d,g_THERMAL_TRIP_1=%d,",
g_THERMAL_TRIP[0], g_THERMAL_TRIP[1]);
		tsallts_dprintk(
...
g_THERMAL_TRIP[8], g_THERMAL_TRIP[9]);
		tsallts_dprintk(
		"[tsallts_write1] cooldev0=%s,cooldev1=%s,cooldev2=%s,cooldev3=%s,cooldev4=%s,",
g_bind0, g_bind1, g_bind2, g_bind3, g_bind4);
		tsallts_dprintk(
...
g_bind5, g_bind6, g_bind7, g_bind8, g_bind9);
		...
		tsallts_dprintk(
			"[tsallts_write] trip_0_temp=%d,trip_1_temp=%d,",
...
static ssize_t tsallts_write5(struct file *file, const char __user *buffer,
	size_t count, loff_t *data)
{
	int len = 0, time_msec = 0;
	int trip[10] = { 0 };
	...
	if (sscanf(desc,
		...
		tsallts_dprintk(
			"[tsallts_write5] g_THERMAL_TRIP_0=%d,g_THERMAL_TRIP_1=%d,",
g_THERMAL_TRIP[0], g_THERMAL_TRIP[1]);
		tsallts_dprintk(
			"g_THERMAL_TRIP_2=%d,g_THERMAL_TRIP_3=%d,g_THERMAL_TRIP_4=%d,",
g_THERMAL_TRIP[2], g_THERMAL_TRIP[3], g_THERMAL_TRIP[4]);
...
g_THERMAL_TRIP[8], g_THERMAL_TRIP[9]);
		tsallts_dprintk(
			"[tsallts_write5] cooldev0=%s,cooldev1=%s,cooldev2=%s,cooldev3=%s,cooldev4=%s,",
g_bind0, g_bind1,	g_bind2, g_bind3, g_bind4);
		tsallts_dprintk(
			"cooldev5=%s,cooldev6=%s,cooldev7=%s,cooldev8=%s,cooldev9=%s\n",
g_bind5, g_bind6, g_bind7, g_bind8, g_bind9);
		...
		tsallts_dprintk(
			"[tsallts_write5] trip_0_temp=%d,trip_1_temp=%d,",
			trip_temp[0], trip_temp[1]);
		tsallts_dprintk("trip_2_temp=%d,trip_3_temp=%d,trip_4_temp=%d,",
trip_temp[2], trip_temp[3], trip_temp[4]);
		tsallts_dprintk("trip_5_temp=%d,trip_6_temp=%d,trip_7_temp=%d,",
...
static ssize_t tsallts_write3(struct file *file, const char __user *buffer,
	size_t count, loff_t *data)
{
	int len = 0, time_msec = 0;
	int trip[10] = { 0 };
	...
	if (sscanf(desc,
		...
		tsallts_dprintk(
			"[tsallts_write3] g_THERMAL_TRIP_0=%d,g_THERMAL_TRIP_1=%d,",
g_THERMAL_TRIP[0], g_THERMAL_TRIP[1]);
		tsallts_dprintk(
			"g_THERMAL_TRIP_2=%d,g_THERMAL_TRIP_3=%d,g_THERMAL_TRIP_4=%d,",
g_THERMAL_TRIP[2], g_THERMAL_TRIP[3], g_THERMAL_TRIP[4]);
...
g_THERMAL_TRIP[8], g_THERMAL_TRIP[9]);
		tsallts_dprintk(
			"[tsallts_write] cooldev0=%s,cooldev1=%s,cooldev2=%s,cooldev3=%s,cooldev4=%s,",
g_bind0, g_bind1, g_bind2, g_bind3, g_bind4);
		tsallts_dprintk(
			"cooldev5=%s,cooldev6=%s,cooldev7=%s,cooldev8=%s,cooldev9=%s\n",
			g_bind5, g_bind6, g_bind7, g_bind8, g_bind9);
		...
		tsallts_dprintk(
			"[tsallts_write3] trip_0_temp=%d,trip_1_temp=%d,",
			trip_temp[0], trip_temp[1]);
		tsallts_dprintk("trip_2_temp=%d,trip_3_temp=%d,trip_4_temp=%d,",
trip_temp[2], trip_temp[3], trip_temp[4]);
		tsallts_dprintk("trip_5_temp=%d,trip_6_temp=%d,trip_7_temp=%d,",
...
static ssize_t tsallts_write4(struct file *file,
	const char __user *buffer, size_t count, loff_t *data)
{
	...
	if (sscanf(desc,
	     ...
	     &t_type[6], bind6, &trip[7], &t_type[7],
	     bind7, &trip[8], &t_type[8], bind8, &trip[9],
	     &t_type[9], bind9, &time_msec) == 32) {
		tsallts_dprintk(
		...
		tsallts_dprintk(
			"[tsallts_write4] g_THERMAL_TRIP_0=%d,",
			g_THERMAL_TRIP[0]);
		tsallts_dprintk(
			"g_THERMAL_TRIP_1=%d,g_THERMAL_TRIP_2=%d,g_THERMAL_TRIP_3=%d,",
		...
		tsallts_dprintk(
			"[tsallts_write4] trip_0_temp=%d,trip_1_temp=%d,",
			trip_temp[0], trip_temp[1]);
		tsallts_dprintk("trip_2_temp=%d,trip_3_temp=%d,trip_4_temp=%d,",
trip_temp[2], trip_temp[3], trip_temp[4]);
		tsallts_dprintk("trip_5_temp=%d,trip_6_temp=%d,trip_7_temp=%d,",
...
{
	cl_dev_sysrst1 = mtk_thermal_cooling_device_register("mtkts1-sysrst",
		NULL, &tsallts_cooling_sysrst_ops1);

	cl_dev_sysrst5 = mtk_thermal_cooling_device_register("mtkts5-sysrst",
		NULL, &tsallts_cooling_sysrst_ops5);

	cl_dev_sysrst3 = mtk_thermal_cooling_device_register("mtkts3-sysrst",
		NULL, &tsallts_cooling_sysrst_ops3);

	cl_dev_sysrst4 = mtk_thermal_cooling_device_register("mtkts4-sysrst",
		NULL, &tsallts_cooling_sysrst_ops4);
...
static int __init tsallts_init(void)
{
	...
	if (!tsallts_dir) {
		...
		entry =
		    proc_create("tzts1", 0664, tsallts_dir, &tsallts_fops1);
		if (entry)
			proc_set_user(entry, uid, gid);

		entry =
		    proc_create("tzts5", 0664, tsallts_dir, &tsallts_fops5);
		if (entry)
			proc_set_user(entry, uid, gid);

		entry =
		    proc_create("tzts3", 0664, tsallts_dir, &tsallts_fops3);
		if (entry)
			proc_set_user(entry, uid, gid);

		entry =
		    proc_create("tzts4", 0664, tsallts_dir, &tsallts_fops4);
		if (entry)
			proc_set_user(entry, uid, gid);
	}

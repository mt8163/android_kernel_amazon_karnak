 ...
 */
#ifndef __MTK_PWM_HAL_PUB_H__
#define __MTK_PWM_HAL_PUB_H__
...
void mt_pwm_power_on_hal
	(uint32_t pwm_no, bool pmic_pad, unsigned long *power_flag);
void mt_pwm_power_off_hal
	(uint32_t pwm_no, bool pmic_pad, unsigned long *power_flag);
...
void mt_set_pwm_con_stpbit_hal
	(uint32_t pwm_no, uint32_t stpbit, uint32_t srcsel);

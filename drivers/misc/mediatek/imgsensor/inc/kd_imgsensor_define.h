...
#define PACDK_SENSOR_INFO2_STRUCT (&ACDK_SENSOR_INFO2_STRUCT)
...
struct IMGSENSOR_CTRL_PIN_CAPABILITY {
	MUINT32 reserved:30;
	MUINT32 flash:1;
	MUINT32 strobe:1;
};
...
struct IMAGESENSOR_GETINFO_STRUCT {
	MUINT32 SensorId;
	struct ACDK_SENSOR_INFO2_STRUCT *pInfo;

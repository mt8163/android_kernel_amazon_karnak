...
#define KDIMGSENSORIOC_DFS_CTRL \
	_IOWR(IMGSENSORMAGIC, 90, unsigned int)
#define KDIMGSENSORIOC_DFS_UPDATE \
	_IOWR(IMGSENSORMAGIC, 95, unsigned int)
#define KDIMGSENSORIOC_GET_SUPPORTED_ISP_CLOCKS \
	_IOWR(IMGSENSORMAGIC, 100, struct IMAGESENSOR_GET_SUPPORTED_ISP_CLK)
#define KDIMGSENSORIOC_GET_CUR_ISP_CLOCK \
	_IOWR(IMGSENSORMAGIC, 105, unsigned int)
...
#define GC2375MIPI_CXT_FRONT_SENSOR_ID          0x2377
...
#define SENSOR_DRVNAME_GC2375MIPI_RAW_CXT_FRONT "gc2375mipi_raw_cxt_front"

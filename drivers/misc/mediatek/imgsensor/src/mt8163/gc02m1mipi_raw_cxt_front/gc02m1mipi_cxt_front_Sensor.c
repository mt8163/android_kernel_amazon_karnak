...
#include "gc02m1mipi_cxt_front_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc02m1_cxt_front_camera_sensor"
#define LOG_1 LOG_INF("gc02m1_cxt_front, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
kal_bool GC02M1_FRONT_DuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1MIPI_CXT_FRONT_SENSOR_ID,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, GC02M1_MIRROR);
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	GC02M1_FRONT_DuringTestPattern = KAL_FALSE;
...
UINT32 GC02M1MIPI_CXT_FRONT_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{

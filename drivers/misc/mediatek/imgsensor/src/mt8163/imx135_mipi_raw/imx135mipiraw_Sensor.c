...
#define LOG_2 LOG_INF("preview 2096*1554@30fps,864Mbps/lane;"
					"video 4196*3108@30fps,864Mbps/lane; capture 13M@30fps,864Mbps/lane\n")
/****************************   Modify end    *******************************************/
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = { {4208, 3120, 0000, 0000, 4208, 3120, 2104, 1560, 0000, 0000, 2104, 1560, 0007, 0007, 2088, 1544},	/* Preview 2112*1558 */
...
static kal_uint32 get_resolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *sensor_resolution)
{
	...
	pr_debug("imgsensor_info.cap.grabwindow_width: %d\n", imgsensor_info.cap.grabwindow_width);
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_SENSOR_OTP_AWB_CMD:
		...
		if (0 != imgsensor.update_sensor_otp_awb || 0 != imgsensor.update_sensor_otp_lsc) {
			otp_update(imgsensor.update_sensor_otp_awb,
				   imgsensor.update_sensor_otp_lsc);
		}
		break;

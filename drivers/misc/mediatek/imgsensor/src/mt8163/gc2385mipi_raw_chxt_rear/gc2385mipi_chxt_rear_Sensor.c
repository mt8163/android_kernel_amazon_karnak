...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2385MIPI_CHXT_REAR_SENSOR_ID,	//record sensor id defined in Kd_imgsensor.h
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((ANALOG_GAIN_1 <= iReg) && (iReg < ANALOG_GAIN_2)) {
		...
		LOG_INF
		    ("GC2385MIPI_CHXT_REAR analogic gain 1x, GC2385MIPI_CHXT_REAR add pregain = %d\n",
		     temp);
	}
		...
		write_cmos_sensor(0xb2, temp & 0xff);
		LOG_INF
		    ("GC2385MIPI_CHXT_REAR analogic gain 1.43x , GC2385MIPI_CHXT_REAR add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, temp & 0xff);
		LOG_INF
		    ("GC2385MIPI_CHXT_REAR analogic gain 2x , GC2385MIPI_CHXT_REAR add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, temp & 0xff);
		LOG_INF
		    ("GC2385MIPI_CHXT_REAR analogic gain 2.84x , GC2385MIPI_CHXT_REAR add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, temp & 0xff);
		LOG_INF
		    ("GC2385MIPI_CHXT_REAR analogic gain 3.97x , GC2385MIPI_CHXT_REAR add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, temp & 0xff);
		LOG_INF
		    ("GC2385MIPI_CHXT_REAR analogic gain 5.68x , GC2385MIPI_CHXT_REAR add pregain = %d\n",
		     temp);
		...
		write_cmos_sensor(0xb2, temp & 0xff);
		LOG_INF
		    ("GC2385MIPI_CHXT_REAR analogic gain 8.14x , GC2385MIPI_CHXT_REAR add pregain = %d\n",
		     temp);
	}
		...
		write_cmos_sensor(0xb2, temp & 0xff);
		LOG_INF
		    ("GC2385MIPI_CHXT_REAR analogic gain 11.34x , GC2385MIPI_CHXT_REAR add pregain = %d\n",
		     temp);
	}
		...
		write_cmos_sensor(0xb2, temp & 0xff);
		LOG_INF
		    ("GC2385MIPI_CHXT_REAR analogic gain 16.23x , GC2385MIPI_CHXT_REAR add pregain = %d\n",
		     temp);
	}
	return gain;
...
UINT32 GC2385MIPI_CHXT_REAR_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT * pfFunc)
{

...
#define VOL_1000 1000000
	...
	if (On) {
                ...
                PK_DBG(" --- SensorName: %s is power on \n",currSensorName);
		if (pinSetIdx == 0 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_GC2355_MIPI_RAW))) {
		...
		} else if (pinSetIdx == 0 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_GC2375MIPI_RAW_CHXT_REAR))) {
			...
			mdelay(10);
		}  else if (pinSetIdx == 0 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_GC2385MIPI_RAW_CHXT_REAR))) {
			...
			mdelay(10);
		} else if (pinSetIdx == 0 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_SP2509MIPI_RAW_BLX_REAR))) {
...
*/			/* VCAM_A */
			...
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST])
				mtkcam_gpio_set(pinSetIdx, CAMRST, 1);
			mdelay(10);
		} else if (pinSetIdx == 0 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_SP2509MIPI_RAW_LYI_REAR))) {
...
*/			/* VCAM_A */
			...
			if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST])
				mtkcam_gpio_set(pinSetIdx, CAMRST, 1);
			mdelay(10);
		} else if (pinSetIdx == 1 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_GC2375MIPI_RAW_BLX_FRONT))) {
			...
			mdelay(10);
		} else if (pinSetIdx == 1 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_GC2375MIPI_RAW_LYI_FRONT))) {
...
*/
			...
			mdelay(10);
		}  else if (pinSetIdx == 1 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_GC2385MIPI_RAW_CHXT_FRONT))) {
		...
		}else if (pinSetIdx == 1 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_SP2509MIPI_RAW_CHXT_FRONT))) {

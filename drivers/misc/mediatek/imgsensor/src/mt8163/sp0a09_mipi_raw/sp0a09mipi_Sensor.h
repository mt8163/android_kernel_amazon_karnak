 ...
 *
 ****************************************************************************/
#ifndef _SP0A09MIPI_SENSOR_H
#define _SP0A09MIPI_SENSOR_H
...
typedef struct imgsensor_mode_struct {
	...
	kal_uint8 mipi_data_lp2hs_settle_dc;	//following for MIPIDataLowPwr2HighSpeedSettleDelayCount by different scenario

	kal_uint16 max_framerate;	//following for GetDefaultFramerateByScenario()

} imgsensor_mode_struct;


typedef struct imgsensor_struct {	//SENSOR PRIVATE STRUCT FOR VARIABLES
...
typedef struct imgsensor_info_struct {	//SENSOR PRIVATE STRUCT FOR CONSTANT

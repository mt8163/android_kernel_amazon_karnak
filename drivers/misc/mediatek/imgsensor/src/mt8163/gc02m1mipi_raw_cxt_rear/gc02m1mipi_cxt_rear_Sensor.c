...
#include "gc02m1mipi_cxt_rear_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc02m1_cxt_rear_camera_sensor"
#define LOG_1 LOG_INF("gc02m1_cxt_rear, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
kal_bool gc02m1DuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1MIPI_CXT_REAR_SENSOR_ID,
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	gc02m1DuringTestPattern = KAL_FALSE;
...
UINT32 GC02M1MIPI_CXT_REAR_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{

...
u16 rtc_read(u16 addr)
{
	...
	//pmic_read_interface((u32)addr, &rdata, 0xFFFF, 0);
	regmap_read(pwrap_regmap, (u32)addr, &rdata);
	return (u16) rdata;
}
...
void rtc_write(u16 addr, u16 data)
{
	...
	//pmic_config_interface((u32)addr, data, 0xFFFF, 0);
	regmap_write(pwrap_regmap, (u32)addr, (u32)data);
}

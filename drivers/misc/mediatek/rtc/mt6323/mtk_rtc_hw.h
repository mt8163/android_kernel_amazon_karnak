...
/* mask for long press reset */
#define RTC_SPAR0_LONG_PRESS_RST	(1U << 10)
...
/* mask for sw long press reset */
#define RTC_SPAR0_SW_LONG_PRESS_RST	(1U << 11)
/* secure for recovery mode */
#define RTC_SPAR0_SECURE_RECOVERY_BIT	(1U << 12)

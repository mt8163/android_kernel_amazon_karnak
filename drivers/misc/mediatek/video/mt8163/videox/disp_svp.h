...
enum DISP_FORMAT {
	...
	DISP_FORMAT_YVYU = MAKE_DISP_FORMAT_ID(
		11, 2), /* Same as UYVY, but replace Y/U/V */
	...
	DISP_FORMAT_YUYV =
		MAKE_DISP_FORMAT_ID(14, 2), /* Same as UYVY but replace U/V */
	...
	DISP_FORMAT_I420 =
		MAKE_DISP_FORMAT_ID(17, 1), /* Same as YV12 but replace U/V */
	DISP_FORMAT_IYUV = MAKE_DISP_FORMAT_ID(17, 1),
	DISP_FORMAT_NV12 = MAKE_DISP_FORMAT_ID(18, 1), /* BPP = 1.5 */
	DISP_FORMAT_NV21 =
		MAKE_DISP_FORMAT_ID(19, 1), /* Same as NV12 but replace U/V */

...
void ddp_dpi_RGB_set_DrivingCurrent(DISP_MODULE_ENUM module, void *cmdq_handle,
				    LCM_DRIVING_CURRENT CURRENT)
{
	switch (CURRENT) {
	...
	if (((s_isDpiConfig == false) && (module == DISP_MODULE_DPI0)) || ((s_isDpi1Config == false)
		...
		if (module == DISP_MODULE_DPI0) {
			...
			if (dpi_config->lvds_tx_en)
				...
				ddp_dpi_RGB_set_DrivingCurrent(module, cmdq_handle,

...
#define MIRAVISION_HW_VERSION (2) /*1:6595 2:6752 3:6795 4:6735*/
...
#define MIRAVISION_VERSION                                                     \
	((MIRAVISION_HW_VERSION << MIRAVISION_HW_VERSION_SHIFT) |              \
	 ...
	 MIRAVISION_SW_FEATURE_VIDEO_DC | MIRAVISION_SW_FEATURE_AAL)
...
#define DISP_COLOR_SWREG_END (DISP_COLOR_SWREG_PQDC_BASE + 0x1000)

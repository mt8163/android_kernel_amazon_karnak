...
enum DPI_POLARITY { DPI_POLARITY_RISING = 0, DPI_POLARITY_FALLING = 1 };
...
enum DPI_STATUS ddp_dpi_3d_ctrl(enum DISP_MODULE_ENUM module,
				struct cmdqRecStruct *cmdq, bool fg3DFrame);

enum DPI_STATUS ddp_dpi_config_colorspace(enum DISP_MODULE_ENUM module,
...
enum DPI_STATUS ddp_dpi_yuv422_setting(enum DISP_MODULE_ENUM module,
				       struct cmdqRecStruct *cmdq,
				       uint32_t uvsw);
enum DPI_STATUS ddp_dpi_clpf_setting(enum DISP_MODULE_ENUM module,
				     struct cmdqRecStruct *cmdq,
				     uint8_t clpfType,
				     bool roundingEnable, uint32_t clpfen);
enum DPI_STATUS ddp_dpi_vsync_lr_enable(enum DISP_MODULE_ENUM module,
					struct cmdqRecStruct *cmdq,
					uint32_t vs_lo_en,
					uint32_t vs_le_en, uint32_t vs_ro_en,
					uint32_t vs_re_en);
enum DPI_STATUS
ddp_dpi_ConfigVsync_LEVEN(enum DISP_MODULE_ENUM module,
		struct cmdqRecStruct *cmdq,
		uint32_t pulseWidth, uint32_t backPorch,
		uint32_t frontPorch, bool fgInterlace);
enum DPI_STATUS ddp_dpi_ConfigVsync_RODD(enum DISP_MODULE_ENUM module,
					 struct cmdqRecStruct *cmdq,
					 uint32_t pulseWidth,
					 uint32_t backPorch,
					 uint32_t frontPorch);
enum DPI_STATUS
ddp_dpi_ConfigVsync_REVEN(enum DISP_MODULE_ENUM module,
		struct cmdqRecStruct *cmdq,
		uint32_t pulseWidth, uint32_t backPorch,
		uint32_t frontPorch, bool fgInterlace);

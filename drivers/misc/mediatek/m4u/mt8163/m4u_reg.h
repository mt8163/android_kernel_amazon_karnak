...
#define F_INT_TRANS_F(MMU)     F_BIT_SET(0+(((MMU)<<1)|((MMU)<<2)))
...
/* (14+(set)+(mmu*4)) */
#define F_INT_MAU(mmu, set)     F_BIT_SET(7+(set)+(mmu<<2))

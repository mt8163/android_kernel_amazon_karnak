...
#define REG_VCODECPLL_CON0  REG_APMIX_ADDR(0x0290)  /* /< FHCTL unsupport, VCODECPLL_CON0 is useless */
...
#define REG_VCODECPLL_CON1  REG_APMIX_ADDR(0x0294)  /* /< FHCTL unsupport, VCODECPLL_CON0 is useless */
/* **************************************************** */
